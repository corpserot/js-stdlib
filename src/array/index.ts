...
/**
 * Returns the position of the last occurance of a value.
 * Returns -1 if the value is not found.
 */
...
/**
 * Returns the position of the first non-occurance of a value.
 * Returns -1 if the value is found on every position.
 */
...
/**
 * Returns the position of the last non-occurrence of a value.
 * Returns -1 if the value is found at every position.
 */
